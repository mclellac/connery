# coding=utf8
"""
reload.py - Connery Module Reloader Module
...
@connery.module.nickname_commands("reload")
...
def f_reload(bot, trigger):
    ...
    # Also remove all references to connery callables from top level of the
...
@connery.module.nickname_commands('update')
...
@connery.module.nickname_commands("load")
@connery.module.priority("low")
@connery.module.thread(False)
...
@connery.module.commands("reload")
@connery.module.priority("low")
@connery.module.thread(False)
...
@connery.module.commands('update')
