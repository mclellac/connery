# coding=utf8
"""
meetbot.py - Connery meeting logger module
...
import time
import os
from connery.web import quote
from connery.modules.url import find_title
from connery.module import example, commands, rule, priority
from connery.tools import Ddict, Identifier
import codecs
...
def configure(config):
    ...
    | --------- | ------- | ------- |
    | meeting_log_path | /home/connery/www/meetings | Path to meeting logs storage directory (should be an absolute path, accessible on a webserver) |
    | meeting_log_baseurl | http://example.com/~connery/meetings | Base URL for the meeting logs directory |
    """
...
def startmeeting(bot, trigger):
    """
    Start a meeting.
    https://github.com/embolalia/connery/wiki/Using-the-meetbot-module
    """
