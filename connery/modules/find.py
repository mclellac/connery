# coding=utf8
"""
find.py - Connery Spelling correction module
...
import re
from connery.tools import Identifier, ConneryMemory
from connery.module import rule, priority
from connery.formatting import bold


def setup(bot):
    bot.memory['find_lines'] = ConneryMemory()
...
def collectlines(bot, trigger):
    ...
    if trigger.sender not in bot.memory['find_lines']:
        bot.memory['find_lines'][trigger.sender] = ConneryMemory()
