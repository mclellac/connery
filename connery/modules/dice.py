...
from connery.tools.calculation import eval_equation
...
@connery.module.commands("roll")
@connery.module.commands("dice")
@connery.module.commands("d")
@connery.module.priority("medium")
@connery.module.example(".roll 3d1+1", 'You roll 3d1+1: (1+1+1)+1 = 4')
@connery.module.example(".roll 3d1v2+1", 'You roll 3d1v2+1: (1[+1+1])+1 = 2')
@connery.module.example(".roll 2d4", 'You roll 2d4: \(\d\+\d\) = \d', re=True)
@connery.module.example(".roll 100d1", '[^:]*: \(100x1\) = 100', re=True)
@connery.module.example(".roll 1001d1", 'I only have 1000 dice. =(')
@connery.module.example(".roll 1d1 + 1d1", 'You roll 1d1 + 1d1: (1) + (1) = 2')
@connery.module.example(".roll 1d1+1d1", 'You roll 1d1+1d1: (1)+(1) = 2')
...
@connery.module.commands("choice")
@connery.module.commands("ch")
@connery.module.commands("choose")
@connery.module.priority("medium")
...
if __name__ == "__main__":
    from connery.test_tools import run_example_tests
