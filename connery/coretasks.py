# coding=utf8
"""
coretasks.py - Connery Routine Core tasks
...
Connery: http://connery.dftba.net/
...
import time
import connery
from connery.tools import Identifier, iteritems
import base64
...
@connery.module.event('001', '251')
@connery.module.rule('.*')
@connery.module.thread(False)
@connery.module.unblockable
...
@connery.module.event('477')
@connery.module.rule('.*')
@connery.module.priority('high')
...
#Functions to maintain a list of chanops in all of connery's channels.


@connery.module.rule('(.*)')
@connery.module.event('353')
@connery.module.priority('high')
@connery.module.thread(False)
@connery.module.unblockable
def handle_names(bot, trigger):
    ...
    # it'd be worth it.
    mapping = {'+': connery.module.VOICE,
               '%': connery.module.HALFOP,
               '@': connery.module.OP,
               '&': connery.module.ADMIN,
               '~': connery.module.OWNER}
...
def track_modes(bot, trigger):
    ...
    mapping = {'v': connery.module.VOICE,
               'h': connery.module.HALFOP,
               'o': connery.module.OP,
               'a': connery.module.ADMIN,
               'q': connery.module.OWNER}
...
@connery.module.event('AUTHENTICATE')
@connery.module.rule('.*')
...
@connery.module.commands('blocks')
@connery.module.priority('low')
@connery.module.thread(False)
@connery.module.unblockable
def blocks(bot, trigger):
    """Manage Connery's blocking features.

    https://github.com/embolalia/connery/wiki/Making-Connery-ignore-people
    ...
    STRINGS = {
        ...
        "invalid": "Invalid format for %s a block. Try: .blocks add (nick|hostmask) connery",
