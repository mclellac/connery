# coding=utf8
"""
chanlogs.py - Connery Channel Logger module
...
def get_fpath(bot, trigger, channel=None):
    ...
    channel = connery.tools.Identifier(channel).lower()
...
def setup(bot):
    ...
    if not bot.memory.contains('chanlog_locks'):
        bot.memory['chanlog_locks'] = connery.tools.ConneryMemoryWithDefault(threading.Lock)
