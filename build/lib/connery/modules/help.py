...
from connery.module import commands, rule, example, priority
from connery.tools import iterkeys
...
def help2(bot, trigger):
    response = (
        ...
        'of my commands, or see http://connery.dftba.net for more ' +
