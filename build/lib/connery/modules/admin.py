...
@connery.module.require_privmsg
@connery.module.require_admin
@connery.module.commands('join')
@connery.module.priority('low')
@connery.module.example('.join #example or .join #example key')
...
@connery.module.require_privmsg
@connery.module.require_admin
@connery.module.commands('part')
@connery.module.priority('low')
@connery.module.example('.part #example')
...
@connery.module.require_privmsg
@connery.module.require_owner
@connery.module.commands('quit')
@connery.module.priority('low')
...
@connery.module.require_privmsg
@connery.module.require_admin
@connery.module.commands('msg')
@connery.module.priority('low')
@connery.module.example('.msg #YourPants Does anyone else smell neurotoxin?')
def msg(bot, trigger):
    """
...
@connery.module.event('INVITE')
@connery.module.rule('.*')
@connery.module.priority('low')
def invite_join(bot, trigger):
    """
    Join a channel connery is invited to, if the inviter is an admin.
    """
...
@connery.module.event('KICK')
@connery.module.rule(r'.*')
@connery.module.priority('low')
def hold_ground(bot, trigger):
    """
    This function monitors all kicks across all channels connery is in. If it
    detects that it is the one kicked it'll automatically join that channel.

    WARNING: This may not be needed and could cause problems if connery becomes
...
@connery.module.require_privmsg
@connery.module.require_admin
@connery.module.commands('mode')
@connery.module.priority('low')
def mode(bot, trigger):
    """Set a user mode on Connery. Can only be done in privmsg by an admin."""
    mode = trigger.group(3)
    bot.write(('MODE ', bot.nick + ' ' + mode))


@connery.module.require_privmsg("This command only works as a private message.")
@connery.module.require_admin("This command requires admin privileges.")
@connery.module.commands('set')
@connery.module.example('.set core.owner Me')
def set_config(bot, trigger):
    """See and modify values of connerys config object.
...
@connery.module.require_privmsg
@connery.module.require_admin
@connery.module.commands('save')
@connery.module.example('.save')
def save_config(bot, trigger):
    """Save state of connerys config object to the configuration file."""
    bot.config.save()
