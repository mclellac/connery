# coding=utf8
"""
remind.py - Connery Reminder Module
...
from connery.module import commands, example, NOLIMIT
...
def dump_database(name, data):
    ...
    for unixtime, reminders in connery.tools.iteritems(data):
...
def at(bot, trigger):
    ...
    message. Timezone is any timezone Connery takes elsewhere; the best choices
